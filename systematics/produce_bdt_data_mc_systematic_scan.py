...
def main(args):
    ...
    eff_ratio = _eff_jpsi_data / _eff_jpsi_mc
    
    print(f'Efficiency Ratio = {eff_ratio.n} \u00B1 {eff_ratio.std_dev}')   
    output_dict = {
        'eff_ratio'        : {'value' : eff_ratio.n, 'uncertainty' : eff_ratio.std_dev},
        'eff_data'         : {'value' : eff_jpsi_data, 'uncertainty' : eff_jpsi_data_err},
        'eff_mc'           : {'value' : eff_jpsi_mc, 'uncertainty' : eff_jpsi_mc_err},
        'yield_num_data'   : {'value' : eff_jpsi_data_comps[0], 'uncertainty' : eff_jpsi_data_comps[1]},
        'yield_denom_data' : {'value' : eff_jpsi_data_comps[2], 'uncertainty' : eff_jpsi_data_comps[3]},
        'yield_num_mc'     : {'value' : eff_jpsi_mc_comps[0], 'uncertainty' : eff_jpsi_mc_comps[1]},
        'yield_denom_mc'   : {'value' : eff_jpsi_mc_comps[2], 'uncertainty' : eff_jpsi_mc_comps[3]},
    }
