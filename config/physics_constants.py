...
SAMPLES = {
    ...
    'k0star_jpsi_kaon': {
        ...
        'label': r'$B^{0} \to J/\psi K^{*0} (K^{+}\pi^{-})$ [K cand]',
        'xs_prod': SIGMA_BB,
    ...
    'k0star_jpsi_pion': {
        ...
        'label': r'$B^{0} \to J/\psi K^{*0} (K^{+}\pi^{-})$ [Pi cand]',
        'xs_prod': SIGMA_BB,
        'bf_chain': BR_B_ZERO_JPSI_KSTAR * BR_K0STAR_KPI * BR_JPSI_EE,
        'n_gen': 81083868,
        'analysis_axe': 0.0,
    ...
    'k0star_psi2s_kaon': {
        ...
        'label': r'$B^{0} \to \psi(2S) K^{*0}$ [K cand]',
        'xs_prod': SIGMA_BB,
    ...
    'k0star_psi2s_pion': {
        ...
        'label': r'$B^{0} \to \psi(2S) K^{*0}$ [Pi cand]',
        'xs_prod': SIGMA_BB,
        'bf_chain': BR_B_ZERO_PSI2S_KSTAR * BR_K0STAR_KPI * BR_PSI2S_EE,
        'n_gen': 783325359,
        'analysis_axe': 0.0,
...
def get_mc_sf(sample_key, lumi=LUMI_2022_EE, bb_xsec=SIGMA_BB, frag_frac=FRAG_FRAC):
    """
